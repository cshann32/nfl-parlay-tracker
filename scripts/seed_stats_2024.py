"""
Seed 2024 NFL season player stats from ESPN's free public API.
Run with: python seed_stats_2024.py
"""
import time
import requests
...
def seed_player_stats():
    ...
    print(f"Fetching 2024 season stats for {len(players)} players...")
